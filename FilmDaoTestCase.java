...
public class FilmDaoTestCase {
	...
	public void initDb() throws Exception {
	 ...
	 public void shouldAddFilm() throws Exception {
		 	LocalDate localDate = LocalDate.of(2015, 12, 26);
			...
			ResultSet resultSet = statement.executeQuery("SELECT * FROM film WHERE title='Les dents de la mer'");
			assertThat(resultSet.next()).isTrue();
			assertThat(resultSet.getInt("idfilm")).isNotNull();
			assertThat(resultSet.getString("title")).isEqualTo("Les dents de la mer");
